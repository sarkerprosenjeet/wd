function navShow() {
  var element = document.getElementById("navShow");
  ...
  function typingEffect() {
      const contactTexts = shuffleArray(['Musician ','Spiritual soul', 'Web developer', ' Cofee Lover', ' Writer',' Travel Lover', 'Spiritual thinker']);
